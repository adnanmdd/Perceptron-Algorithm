<h2>Perceptron Algorithm — Pass vs Fail Problem</h2>
...
<p>
After training, the perceptron successfully classifies students based on the learned pattern.
It creates a decision boundary that distinguishes between passing and failing cases.
</p>
